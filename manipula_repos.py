...
novo_repo = ManipulaRepositorios()
...
novo_repo.add_arquivo(nome_repo, 'linguagens_amzn.csv', 'data/linguagens_amazon.csv')
novo_repo.add_arquivo(nome_repo, 'linguagens_netflix.csv', 'data/linguagens_netflix.csv')
novo_repo.add_arquivo(nome_repo, 'linguagens_spotify.csv', 'data/linguagens_spotify.csv')